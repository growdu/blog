...
```shell
C:\Usersgrowd>vfox add golang/golang 
...
Version -> 0.0.2
Desc    ->
Path    -> C:\Usersgrowd\.version-foxplugingolangmain.lua
...
```shell
C:\Usersgrowd>vfox install golang@latest
...
Unpacking C:\Usersgrowd\.version-foxcachegolanggo1.22.1.windows-amd64.zip...
...
C:\Usersgrowd>vfox use -g golang@1.22.1
