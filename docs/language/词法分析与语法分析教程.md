...
```shell
$ flex --version
D:\dev-toolflexGnuWin32binflex.exe version 2.5.4
$ bison --version
...
```shell
flex .\number.l
D:\codeblogcodeflex_bison_test> ls

    目录: D:\codeblogcodeflex_bison_test
...
```shell
D:\codeblogcodeflex_bison_test> gcc .\lex.yy.c -o number
PS D:\codeblogcodeflex_bison_test> ls
